        ...
        <div class="col-md-auto border rounded m-3 shadow">
            <form class="form-floating " action="/signup" method="POST">
                ...
                <div class="form-floating mb-3">
                    <input type="text"
                           class="form-control <?= isset($isNameValid) ? ($isNameValid && isset($isNameAvailable) && $isNameAvailable ? 'is-valid' : 'is-invalid') : '' ?> "
                           id="usernameInput" placeholder="username"
                           name="name" <?= isset($name) ? "value=\"$name\"" : '' ?>
                           required>
                    <label for="usernameInput">Username</label>
                    <div class="invalid-feedback">
                        <?= isset($isNameValid) && $isNameValid ? 'Username is already taken!' : 'Username should contain latin letters, digits or _' ?>
                    </div>
                ...
                <div class="form-floating mb-3">
                    ...
                    <div class="invalid-feedback">
                        <?= isset($isNameValid) && $isNameValid ? 'Email is already taken!' : 'Email should be like this: email@example.org' ?>
                    </div>
                    <div class="valid-feedback">
                        Nice email!
                    </div>
